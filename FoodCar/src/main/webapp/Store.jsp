						...
						<div class="schedule">
							...
							<div id="GoogleMap">
								<div class="map" style="height: auto;">
									...
									<img data-toggle="modal" data-target="#myModalHorizontal"
										id='123'
...
$("#123").attr("src","http://maps.googleapis.com/maps/api/staticmap?center="+location+"&zoom=16&size=1000x300&scale=2&markers="+location+"&key=AIzaSyAgdzYOT0U2y-fUVpAfkf-XjCvXzY5-e-A");
$("#123").on('mouseover',function(){
	$("#123").css({"cursor":"pointer"});
});
$("#123").on('click',function(){
	$("#123").attr("data-toggle",'modal');
	$("#123").attr("data-target",'#myModalHorizontal');
});
