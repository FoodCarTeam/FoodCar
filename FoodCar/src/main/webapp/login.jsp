...
<link rel='stylesheet' id='main-stylesheet-css'  href='bootstrap/login/css/style.css' type='text/css' media='all' />
      <!--橘色header色塊控制與Menu控制-->
<link rel='stylesheet' id='slicknav-css'  href="bootstrap/login/css/mobile%20menu%20style.css" type='text/css' media='all' />
...
<div class="container">
  ...
  <div class="tab-content">
   ...
   <form class="form-inline" role="form" action="<c:url value='/Login' />" method="post">
    <p></p>

        <label for="inputEmail" class="sr-only" >請輸入帳號E-mail</label>
        <input type="email" id="inputEmail" name="mUsername" class="form-control" placeholder="請輸入E-mail" required autofocus style="font-size:15px">

        <label for="inputPassword" class="sr-only">請輸入密碼</label>
        <input type="password" id="inputPassword" name="mPassword" class="form-control" placeholder="請輸入密碼" required style="font-size:15px">
  ...
  <p></p>
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit">登入</button></div>
      </form>
    ...
    <p></p>
        ...
        <label for="" class="sr-only">請輸入手機號碼</label>
        <input type="text" class="form-control" placeholder="請輸入手機號碼" required autofocus style="font-size:15px">

        <label for="inputPassword" class="sr-only">請輸入密碼</label>
        <input type="password" id="Password1" class="form-control" placeholder="請輸入密碼" required style="font-size:15px">
        <p></p>
          <div class="checkbox">
          <label>
            <input type="checkbox" value="remember-me"> 記住密碼
    ...
    <div id="boss" class="tab-pane fade">
      ...
      <form class="form-inline" role="form">
    <p></p>
        <label for="" class="sr-only">請輸入帳號</label>
        <input type="text" class="form-control" placeholder="請輸入帳號" required autofocus style="font-size:15px">

        <label for="inputPassword" class="sr-only">請輸入密碼</label>
        <input type="password" id="Password2" class="form-control" placeholder="請輸入密碼" required style="font-size:15px">
 <p></p>
           <div class="checkbox">
          <label>
            <input type="checkbox" value="remember-me">記住密碼
...
<!--/MainContent-->
	...
	<!-- /Footer -->
<!--menu縮小控制-->
      <script type='text/javascript' src="bootstrap/login/js/jquery.slicknav.js"></script>    
